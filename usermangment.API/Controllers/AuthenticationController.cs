...
namespace usermangment.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetDistinctCategories")]
        public async Task<IActionResult> GetDistinctCategories()
        {
        
            var distinctCategories = _userManager.Users
                 .GroupBy(u => u.UserName)  // Group users by categories
                 .Select(g => new { Category = g.Key, Count = g.Count() })  // Create objects with category and count
                 .ToList();
        ...
        public IActionResult GetDoctors()
        {
            ...
            var usersWithProperties = allUsers
                .Where(u => _userManager.GetRolesAsync(u).Result.Contains("Doctor"))
                .Select(u => new
                {
                    UserName = u.UserName,
                    LastName = u.LastName,
                    Email = u.Email,
                    PersonId = u.PersonalId,
                    Category = u.Category,
            ...
            // Add other properties you want to include here
                ...
                .OrderByDescending(u => u.Pinned)
                .ToList();

            return Ok(usersWithProperties);
        }
